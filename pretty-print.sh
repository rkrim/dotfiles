...
ATTR_RESET_BOLD='21'
ATTR_RESET_DIM='22'
ATTR_RESET_UNDERLINE='24'
ATTR_RESET_BLINK='25'
ATTR_RESET_REVERSE='27'
ATTR_RESET_HIDE='28'
...
FG_COLOR_MAGENTA='35'
FG_COLOR_CYAN='36'
FG_COLOR_LIGHT_GRAY='37'
FG_COLOR_DARK_GRAY='90'
FG_COLOR_LIGHT_RED='91'
FG_COLOR_LIGHT_GREEN='92'
FG_COLOR_LIGHT_YELLOW='93'
...
txt_attr() {
	...
	local len=$((${#ATTR_EXP} - 1))
	ATTR_EXP="${ESC_SEQ}[${ATTR_EXP:0:$len}m"
	echo -e "$ATTR_EXP"
}
